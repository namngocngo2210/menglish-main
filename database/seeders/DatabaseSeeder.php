...
class DatabaseSeeder extends Seeder
{
     ...
     *
     * Ngoại lệ: DemoPhase1Seeder / DemoPhase2Seeder / DemoPhase3Seeder (dữ liệu nghiệp vụ mẫu) chỉ chạy ở local/testing/staging
     * hoặc SEED_DEMO=true.
     */
    public function run(): void
    {
        ...
        // hoa hồng, kỳ lương tháng trước đã duyệt + tháng này đang soát) dựng trên buổi học / khách của Phase 1–2.
