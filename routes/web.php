...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('tuition')->name('tuition.')->middleware('can:tuition.view')->group(function () {
        ...
        // Quyền duyệt theo loại hồ sơ (TuitionRefundRequest::approvePermission) — kiểm tra trong controller.
        Route::post('/refunds/{id}/approve', [TuitionController::class, 'approveRefundRequest'])->name('refunds.approve');
        Route::post('/refunds/{id}/reject', [TuitionController::class, 'rejectRefundRequest'])->middleware('can:refund_transfer.reject')->name('refunds.reject');
    ...
    Route::prefix('students')->name('students.')->middleware('can:student.view')->group(function () {
        ...
        Route::post('/{id}/end-deferral', [StudentProfileController::class, 'endDeferral'])->middleware('can:student.change_status')->name('end-deferral');
    ...
    Route::prefix('syllabus')->name('syllabus.')->middleware('can:syllabus.view')->group(function () {
        ...
        Route::put('/curriculums/{id}', [SyllabusController::class, 'updateCurriculum'])->whereNumber('id')->middleware('can:syllabus.manage')->name('curriculums.update');
        Route::delete('/curriculums/{id}', [SyllabusController::class, 'destroyCurriculum'])->whereNumber('id')->middleware('can:syllabus.manage')->name('curriculums.destroy');
