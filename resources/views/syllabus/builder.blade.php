<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-2">
                <x-ui.button variant="secondary" icon="assignment_ind" :href="route('syllabus.assignments')">Chặng của lớp (Bước #3)</x-ui.button>
                @can('syllabus.manage')
    ...
    <div class="max-w-5xl mx-auto space-y-6 pb-10">
        ...
        <div class="flex items-center justify-end gap-2">
            ...
            <x-ui.button icon="arrow_forward" :href="route('syllabus.assignments')">Tiếp tục: Chặng của lớp (Bước #3)</x-ui.button>
        </div>
    </div>
</x-app-layout>
