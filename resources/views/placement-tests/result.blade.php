        ...
        <form action="{{ route('placement-tests.results.update', $submission->id) }}" method="POST" class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
                <div>
                    ...
                    <input type="text" name="recommended_course" value="{{ $submission->recommended_course ?? ($submission->customer?->course_interest ?? 'IELTS 6.5 Intensive') }}" class="w-full text-xs font-bold text-[#F5691A] rounded-xl border border-gray-200 p-2.5 bg-white shadow-2xs" />
                </div>
                <div>
