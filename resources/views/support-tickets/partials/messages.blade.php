                        ...
                        @foreach ($msg->attachment_list as $file)
                            ...
                            @if ($isImg)
                                ...
                                <a href="{{ $fileUrl }}" target="_blank" rel="noopener" hx-boost="false"
                                   class="group relative block rounded-xl border border-gray-200 overflow-hidden bg-gray-50 hover:shadow-md transition cursor-pointer"
                            ...
                            @else
                                <a href="{{ $fileUrl }}" target="_blank" hx-boost="false" class="flex items-center gap-2 p-2.5 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 transition shadow-sm group">
