        ...
        <form method="POST" action="{{ $user->exists ? route('users.update', $user) : route('users.store') }}" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" id="employee_code" name="employee_code" class="w-full bg-white border border-gray-200 text-gray-900 rounded-xl text-sm focus:ring-primary-container focus:border-primary-container p-2.5 font-mono shadow-2xs" value="{{ old('employee_code', $user->employee_code) }}" placeholder="VD: NV-0012">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="email" id="email" name="email" class="w-full bg-white border border-gray-200 text-gray-900 rounded-xl text-sm focus:ring-primary-container focus:border-primary-container p-2.5 shadow-2xs" value="{{ old('email', $user->email) }}" placeholder="VD: nva@menglish.edu.vn" required>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <select id="branch_id" name="branch_id" class="w-full bg-white border border-gray-200 text-gray-900 rounded-xl text-sm focus:ring-primary-container focus:border-primary-container p-2.5 shadow-2xs" required>
                ...
                <div>
                    ...
                    <select id="role" name="role" class="w-full bg-white border border-gray-200 text-gray-900 rounded-xl text-sm focus:ring-primary-container focus:border-primary-container p-2.5 shadow-2xs" required>
            ...
            <div>
                ...
                <input type="password" id="password" name="password" class="w-full bg-white border border-gray-200 text-gray-900 rounded-xl text-sm focus:ring-primary-container focus:border-primary-container p-2.5 shadow-2xs" {{ $user->exists ? '' : 'required' }} placeholder="Tối thiểu 8 ký tự">
            ...
            <div class="pt-4 border-t border-gray-200 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="id_card_number" name="id_card_number" class="w-full bg-white border border-gray-200 text-gray-900 rounded-xl text-sm focus:ring-primary-container focus:border-primary-container p-2.5 font-mono shadow-2xs" value="{{ old('id_card_number', $user->id_card_number) }}" placeholder="VD: 001201004567">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="hometown" name="hometown" class="w-full bg-white border border-gray-200 text-gray-900 rounded-xl text-sm focus:ring-primary-container focus:border-primary-container p-2.5 shadow-2xs" value="{{ old('hometown', $user->hometown) }}" placeholder="VD: Hà Nội">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" id="graduation_school" name="graduation_school" class="w-full bg-white border border-gray-200 text-gray-900 rounded-xl text-sm focus:ring-primary-container focus:border-primary-container p-2.5 shadow-2xs" value="{{ old('graduation_school', $user->graduation_school) }}" placeholder="VD: ĐH Sư Phạm Hà Nội">
                    </div>
                    <div>
                        <label for="certificates" class="block text-[11px] font-bold uppercase text-gray-600 mb-1">Chứng chỉ</label>
                        <input type="text" id="certificates" name="certificates" class="w-full bg-white border border-gray-200 text-gray-900 rounded-xl text-sm focus:ring-primary-container focus:border-primary-container p-2.5 shadow-2xs" value="{{ old('certificates', $user->certificates) }}" placeholder="VD: IELTS 8.0, TESOL">
                    </div>
                    <div>
                        <label for="teaching_level" class="block text-[11px] font-bold uppercase text-gray-600 mb-1">Level giảng dạy</label>
                        <input type="text" id="teaching_level" name="teaching_level" class="w-full bg-white border border-gray-200 text-gray-900 rounded-xl text-sm focus:ring-primary-container focus:border-primary-container p-2.5 shadow-2xs" value="{{ old('teaching_level', $user->teaching_level) }}" placeholder="VD: IELTS Intensive, Pre-G1">
                    </div>
                </div>
                ...
                <div class="pt-3 border-t border-dashed border-gray-200 space-y-3">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <select id="contract_type" name="contract_type" class="w-full bg-white border border-gray-200 text-gray-900 rounded-xl text-sm focus:ring-primary-container focus:border-primary-container p-2.5 shadow-2xs">
                        ...
                        <div>
                            ...
                            <input type="number" id="base_salary" name="base_salary" min="0" step="1000" class="w-full bg-white border border-gray-200 text-gray-900 rounded-xl text-sm focus:ring-primary-container focus:border-primary-container p-2.5 font-mono shadow-2xs" value="{{ old('base_salary', $user->base_salary) }}" placeholder="VD: 15000000">
                        </div>
                        <div>
                            <label for="hourly_rate" class="block text-[11px] font-bold uppercase text-gray-600 mb-1">Thù lao giờ dạy (VNĐ)</label>
                            <input type="number" id="hourly_rate" name="hourly_rate" min="0" step="1000" class="w-full bg-white border border-gray-200 text-gray-900 rounded-xl text-sm focus:ring-primary-container focus:border-primary-container p-2.5 font-mono shadow-2xs" value="{{ old('hourly_rate', $user->hourly_rate) }}" placeholder="VD: 250000">
                        </div>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label for="contract_start_date" class="block text-[11px] font-bold uppercase text-gray-600 mb-1">Ngày bắt đầu hợp đồng</label>
                            <input type="date" id="contract_start_date" name="contract_start_date" class="w-full bg-white border border-gray-200 text-gray-900 rounded-xl text-sm focus:ring-primary-container focus:border-primary-container p-2.5 shadow-2xs" value="{{ old('contract_start_date', $user->contract_start_date?->format('Y-m-d')) }}">
                        </div>
                        <div>
            ...
            <div class="pt-4 border-t border-gray-100 flex items-center justify-end gap-3">
                ...
                <button type="submit" class="px-5 py-2.5 rounded-xl bg-primary-container hover:bg-primary text-white text-xs font-semibold shadow-sm transition">
