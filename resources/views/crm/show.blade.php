<x-app-layout>
    ...
    @if ($errors->has('stage') || $errors->has('class_session_ids') || $errors->has('reason'))
        <div class="mb-4 p-4 bg-rose-50 border border-rose-200 rounded-2xl text-xs font-semibold text-rose-800">
            {{ $errors->first('stage') ?: ($errors->first('class_session_ids') ?: $errors->first('reason')) }}
        </div>
    @endif
