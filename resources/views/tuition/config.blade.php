    ...
    <div class="max-w-4xl mx-auto space-y-6">
        <form action="{{ route('tuition.config.update') }}" method="POST" class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex items-center gap-2">
                            <input type="checkbox" name="auto_issue" value="1" {{ ($invoiceConfig->auto_issue ?? true) ? 'checked' : '' }} id="autoIssue" class="rounded text-primary focus:ring-primary-container" />
            ...
            <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
                <button type="submit" class="px-5 py-2.5 bg-primary-container hover:bg-primary-hover text-white text-xs font-bold rounded-xl shadow-sm transition">
