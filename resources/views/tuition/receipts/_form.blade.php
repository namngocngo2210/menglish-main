                ...
                <div class="mt-4 pt-4 border-t border-slate-200 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div class="flex flex-col items-end gap-1 w-full md:w-auto text-xs">
                        ...
                        <div class="flex items-center gap-3">
                            <label for="{{ $asModal ? 'modal-' : '' }}collectAmount" class="text-slate-500 font-medium">Thu đợt này (để trống = thu hết):</label>
                            <input id="{{ $asModal ? 'modal-' : '' }}collectAmount" type="number" min="0" :max="tuitionSubtotal" x-model="collectAmount" class="w-36 h-9 rounded-xl border border-slate-200 text-xs font-mono font-bold px-2 text-right" placeholder="Toàn bộ" />
                        </div>
                        <div class="flex items-baseline gap-4">
