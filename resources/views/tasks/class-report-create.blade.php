...
<x-app-layout title="Nộp báo cáo trực lớp">
    <div class="mx-auto max-w-2xl space-y-md pb-24 md:pb-0"
         x-data="{
        ...
        <form method="GET" action="{{ route('tasks.class-reports.create') }}" class="rounded-xl border border-outline-variant bg-surface-container-lowest p-md">
            ...
            <div class="flex items-center gap-sm">
                ...
                <label class="min-w-0 flex-1">
                    ...
                    <select name="class_id" onchange="this.form.submit()" @disabled($task?->class_id)
        ...
        <form action="{{ route('tasks.class-reports.store') }}" method="POST" enctype="multipart/form-data" class="space-y-md">
            @csrf
            ...
            <div class="space-y-md rounded-xl border border-outline-variant bg-surface-container-lowest p-md">
                <x-ui.textarea name="hom_nay_hoc_gi" label="Hôm nay học gì" required rows="3" placeholder="Tóm tắt nội dung chính đã giảng dạy..." />
                <x-ui.textarea name="nhat_ky_day" label="Nhật ký dạy (Tùy chọn)" rows="3" placeholder="Ghi chú về thái độ học tập, vấn đề phát sinh..." />
