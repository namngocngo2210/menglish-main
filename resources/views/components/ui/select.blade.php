...
--}}
@props(['name' => null, 'label' => null, 'options' => [], 'value' => null, 'placeholder' => null, 'required' => false, 'hint' => null, 'inlineLabel' => null])
...
@if ($label)
    <x-ui.field :label="$label" :name="$name" :for="$id" :required="$required" :hint="$hint">@include('components.ui.partials.select-control')</x-ui.field>
@elseif ($inlineLabel)
