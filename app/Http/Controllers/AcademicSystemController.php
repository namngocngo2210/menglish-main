...
class AcademicSystemController extends Controller
{
    ...
    public function show(Request $request, string $category, string $screen)
    {
        ...
        $nativeRouteMap = [
            ...
            '03_Cong_Giao_Vien/07_chang_dang_day_va_order_test' => route('syllabus.teaching-stages'),
            '03_Cong_Giao_Vien/10_lich_du_kien_big_test' => route('syllabus.teaching-stages'),
